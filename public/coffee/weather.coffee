class Weather
  ...
  setupSideMenu: () ->
    ...
    $('#sidebar').html('<h2>Cities</h2><ul class="cities"><li><a href="#">CANTERBURY</a></li><li><a href="#">LONDON</a></li><li><a href="#">CAIRO</a></li></ul><ul class="temperature"><li>fahrenheit</li><li>celsius<li></ul>')
