...
(function() {
  ...
  Weather = (function() {
    ...
    Weather.prototype.setupMainView = function(data) {
      ...
      console.log(data);
      $('body').addClass('weather').html('<div id="container"><div id="mainView"><canvas id="weather-icon" width="140" height="140"></canvas><h2>' + localStorage.getItem("city1").toUpperCase() + '</h2><h1 class="temperature">' + Weather.prototype.convertTemperature('c', data.currently.temperature) + '°</h1><ul id="daily"></ul></div><div id="sidebar"></div></div>');
